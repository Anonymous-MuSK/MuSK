...
checkpt_file = "./student/studentkd_"+str(args.data)+str(args.layer)+str(lbd_kl)+str(args.kernel)+str(nlayers)+".pth"
...
def train():
    ...
    # final_loss
    loss_train = loss_CE + lbd_kl*loss_task
    loss_train.backward()
    optimizer.step()
...
def validate():
    ...
    with torch.no_grad():
        ...
        loss_val = loss_CE + lbd_kl*loss_task
